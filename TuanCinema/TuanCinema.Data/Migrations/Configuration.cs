namespace TuanCinema.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TuanCinemaContext>
    {
        ...
        protected override void Seed(TuanCinemaContext context)
        {
            //  tạo thể loại
            ...
            // username: tuanhpi1997, password: TuanCinema
            context.UserSet.AddOrUpdate(u => u.Email, new User[]{
                new User()
                {
                    Email="tuan.9a8.dt@gmail.com",
                    Username="tuanhpi1997",
