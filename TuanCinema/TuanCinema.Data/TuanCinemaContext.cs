using TuanCinema.Data.Configurations;
...
namespace TuanCinema.Data
{
    public class TuanCinemaContext : DbContext
    {
        public TuanCinemaContext()
            : base("TuanCinema")
        {
            Database.SetInitializer<TuanCinemaContext>(null);
        }
